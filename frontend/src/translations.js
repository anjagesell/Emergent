...
export const translations = {
  de: {
    nav: {
      ...
      z9: 'Stellenangebote',
      origin: 'Die Entstehungsgeschichte'
    },
    home: {
      title: 'Willkommen bei OCTA',
      intro1: 'Als zertifizierter Dienstleister für ganzheitliche Pflege- und Betreuungsleistungen stehen wir pflegebedürftigen und schwerbehinderten Menschen in allen Lebenslagen zur Seite – ob die benötigte Unterstützung geringfügiger oder komplexer Natur ist. Unsere Dienststelle vereint professionelle Pflege, hauswirtschaftliche Unterstützung und individuelle Betreuungsangebote unter einem Dach, um ein selbstbestimmtes und würdevolles Leben in den eigenen vier Wänden oder in betreuten Wohnformen zu ermöglichen.',
      intro2: 'Alle Dienste von OCTA dienen letztlich einem gemeinsamen Ziel: Menschen mit Pflegebedarf oder Schwerbehinderung ein verlässlicher Partner zu sein – von der kleinsten alltäglichen Hilfestellung bis hin zur umfassenden pflegerischen Versorgung. Mit unserem interdisziplinären Team aus examinierten Pflegefachkräften, zertifizierten Betreuungskräften und qualifizierten Hauswirtschaftskräften bieten wir Ihnen maßgeschneiderte Lösungen, die sich flexibel an Ihren individuellen Bedürfnissen und Ihrer jeweiligen Lebenssituation orientieren.',
      intro3: 'Unser Anspruch ist es, durch fachliche Kompetenz, Herzenswärme und Zuverlässigkeit Lebensqualität zu schaffen und zu erhalten – unabhängig davon, ob Sie leichte Unterstützung im Haushalt, intensive pflegerische Betreuung oder eine Kombination verschiedener Leistungen benötigen.',
      servicesTitle: 'Unsere Leistungsbereiche im Überblick:',
      certTitle: 'Unsere Qualifikationen und Zertifizierungen',
      certIntro: 'Alle unsere Leistungen werden von qualifiziertem und zertifiziertem Personal erbracht, das den gesetzlichen Anforderungen der deutschen Pflegegesetzgebung entspricht:',
      ctaText: 'Wählen Sie aus der Navigation einen unserer Leistungsbereiche aus, um detaillierte Informationen zu erhalten, oder kontaktieren Sie uns für eine persönliche Beratung.'
    },
    categories: {
      z1: {
      ...
      z2b: {
        title: 'PflegePlus',
        desc: 'Sich schön fühlen, verwöhnt werden und am Leben teilhaben – auch wenn der Gang in die Öffentlichkeit schwerfällt. Mit PflegePlus kommen Friseur, Kosmetik und Wellness diskret zu Ihnen nach Hause.',
        fullText: 'Viele Seniorinnen und Senioren kennen dieses Gefühl: Man möchte sich gerne einen neuen Haarschnitt gönnen, sich durch eine wohltuende Fußpflege verwöhnen lassen oder sich mit einer schönen Maniküre etwas Gutes tun. Vielleicht träumt man sogar von einem kompletten Makeover mit professioneller Kosmetik. Doch die Unsicherheit, sich alleine in die Öffentlichkeit zu begeben, die Angst vor Stürzen oder die Scham über die eigene Einschränkung hält einen zurück. Der Wunsch nach Teilhabe und danach, sich attraktiv und gepflegt zu fühlen, bleibt unerfüllt.\n\nGenau hier setzt unser PflegePlus-Konzept an: Wir bringen die Dienstleistungen zu Ihnen nach Hause! In Ihrer vertrauten, sicheren Umgebung können Sie sich verwöhnen lassen, ohne sich Sorgen machen zu müssen. Unsere Kooperationspartner sind nicht nur fachlich qualifiziert, sondern auch besonders einfühlsam im Umgang mit Seniorinnen und Senioren. Sie nehmen sich Zeit, gehen auf Ihre Wünsche ein und schaffen eine angenehme Atmosphäre – ob beim entspannten Friseurbesuch am Küchentisch, bei der wohltuenden Fußpflege im Wohnzimmer oder beim aufregenden Makeover mit professioneller Kosmetikberatung.\n\nSie müssen sich um nichts kümmern: Wir koordinieren alle Termine, stellen den Kontakt zu den Dienstleistern her und sorgen dafür, dass alles nach Ihren Wünschen abläuft. Die Fachkräfte kommen mit allem notwendigen Equipment direkt zu Ihnen und arbeiten diskret, respektvoll und mit viel Verständnis für Ihre Situation. So können Sie trotz eingeschränkter Mobilität weiterhin am Leben teilhaben, sich schön fühlen und sich etwas gönnen – ganz ohne den Stress, das Haus verlassen zu müssen.',
        services: [
      ...
      z8: {
        ...
        fullText: 'Unsere Wohlfühlstation wurde ins Leben gerufen mit einer Gedenktafel an Andreas und Anna Iris Schmidt geborene Waldecker aus Gilmerdingen. Sie verkörpert den Lebenstraum der ehemaligen Krankenschwester Anna Iris Schmidt – einer liebevollen 11-fachen Mutter und verstorbenen Ehefrau von Andreas Schmidt, sowie Mutter der OCTA-Inhaberin Lois. Hier herrscht eine ganz besondere Atmosphäre des Wohlergehens, die von diesem berührenden Vermächtnis durchdrungen ist.\n\nPflege bedeutet nicht nur medizinische Versorgung und Unterstützung bei alltäglichen Verrichtungen – sie umfasst auch die Förderung von Lebensfreude, Wohlbefinden und Lebensqualität. Unsere Wohlfühlstation ist ein besonderer Ort, an dem Sie zur Ruhe kommen, neue Energie schöpfen und Aktivitäten nachgehen können, die Ihnen Freude bereiten. In angenehmer Atmosphäre bieten wir Ihnen ein vielfältiges Angebot, das Körper, Geist und Seele gleichermaßen anspricht.\n\nOb Sie sich bei sanften Wellness-Anwendungen entspannen, bei kreativen Tätigkeiten Ihre Kreativität ausleben oder bei geselligen Runden neue Kontakte knüpfen möchten – hier finden Sie den Raum dafür. Besonders für Menschen mit Demenz oder kognitiven Einschränkungen haben wir spezielle Angebote entwickelt, die auf wissenschaftlich fundierten Konzepten beruhen. Durch gezielte Sinnesanregung, biografieorientierte Aktivitäten und validierenden Umgang schaffen wir Momente der Freude und des Erkennens. Auch Angehörige schätzen unsere Wohlfühlstation: Sie wissen ihre Liebsten gut aufgehoben und können selbst einmal durchatmen, während diese an einem schönen Ort eine bereichernde Zeit verbringen.',
        services: [
          'Besondere Atmosphäre des Wohlergehens',
      ...
      z9: {
        ...
        desc: 'Ihr Kind gut betreut, während Sie arbeiten – direkt bei uns im Haus! Entdecken Sie unser einzigartiges Eltern-Arbeitsmodul mit hauseigener Kinderbetreuung und werden Sie Teil der OCTA-Familie.',
        fullText: 'Kennen Sie das Gefühl, morgens zur Arbeit zu fahren und sich gleichzeitig Sorgen zu machen, ob Ihr Kind in der Kita gut aufgehoben ist? Die ständige Suche nach Betreuungsplätzen, die Angst vor Krankheitstagen, wenn die Kita wieder schließt, und das schlechte Gewissen, weil man sein Kind so früh abgeben und so spät abholen muss? Bei OCTA gehört diese Zerrissenheit der Vergangenheit an!\n\nUnser **Eltern-Arbeitsmodul** macht den entscheidenden Unterschied: Wir betreiben eine **hauseigene Kinderbetreuungsstelle** direkt in unserem Betrieb. Das bedeutet für Sie: Ihr Kind ist während Ihrer Arbeitszeit bei uns, in liebevoller, professioneller Betreuung – nur wenige Schritte von Ihrem Arbeitsplatz entfernt. Sie kommen morgens gemeinsam an, Ihr Kind geht zur Betreuung, Sie gehen zur Arbeit. In der Pause können Sie nach Ihrem Kind schauen oder gemeinsam Mittag essen. Nach Feierabend fahren Sie zusammen nach Hause. Kein Stress, kein schlechtes Gewissen, kein organisatorischer Spagat zwischen verschiedenen Orten.\n\nDoch das ist nur der Anfang dessen, was OCTA als Arbeitgeber auszeichnet: Wir bieten Ihnen **variable Arbeitszeitmodelle**, die sich Ihrem Leben anpassen – von Vollzeit über verschiedene Teilzeitmodelle bis hin zu Minijobs oder flexiblen Springerdiensten. Sie entscheiden, was zu Ihrer Familiensituation passt! Auch **ehrenamtliches Engagement** ist bei uns herzlich willkommen: Wenn Sie sich sozial einbringen möchten, ohne fest angestellt zu sein, bieten wir sinnvolle Tätigkeiten in der Betreuung und bei Besuchsdiensten. Dazu kommen faire, transparente Bezahlung, kontinuierliche Weiterbildung, modernste Ausstattung und ein Team, das wirklich füreinander da ist. Denn bei OCTA verstehen wir: Nur wenn Sie sich wohlfühlen und Ihr Familienleben im Gleichgewicht ist, können Sie mit ganzer Kraft und Freude für unsere Klienten da sein.',
        services: [
      ...
      origin: {
        ...
        fullText: `Unsere Chefin, Lois Schmidt, ist weit mehr als nur eine ausgebildete Fachkraft aus dem Gesundheitswesen. Sie ist eine Visionärin mit Weitblick, deren Herz für Menschen schlägt. Ihr Wesen sprudelt über vor Kreativität, Hingabe, Lösungsorientierung und einer tief verwurzelten Menschenliebe, die jeden berührt, der ihr begegnet. Dies ist kein Zufall – sondern das Vermächtnis einer Familie, die dem Dienst am Menschen ihr Leben gewidmet hat.

Andreas und Anna Schmidt. Zwei Namen, die für bedingungslose Nächstenliebe stehen. Beide widmeten ihr Leben dem Gesundheitswesen, beide lebten für das Wohl ihrer Mitmenschen. Gemeinsam mit zehn weiteren liebevollen Geschwistern wuchs Lois in einem Zuhause auf, in dem Gemeinschaft, Empathie und eine tiefe Verbundenheit zur Natur und den Tieren nicht nur Worte waren, sondern gelebte Werte. In dieser Wiege der Menschlichkeit wurde der Same für OCTA gelegt.

Es war nur eine Frage der Zeit, bis Lois ihr außergewöhnliches Potenzial entfaltete – nicht für sich selbst, sondern für die nächste Generation. Sie erkannte, dass die ambulante Krankenpflege dringend eine Revolution brauchte: eine Revolution der Menschlichkeit, der Innovation, der Wertschätzung. Ob in der direkten Pflege am Menschen oder in der hauswirtschaftlichen Unterstützung – Lois sah überall das gleiche Muster: veraltete Systeme, die nicht nur Patienten, sondern auch die Helden des Alltags – die Pflegekräfte – vergessen hatten.

Denn Lois kämpft nicht nur für die Würde und das Wohlbefinden der Patienten und Klienten. Ihr liegt das Schicksal der Mitarbeiter genauso am Herzen – der Menschen, die Tag für Tag mit ganzer Seele pflegen, betreuen und helfen. Sie sah zu viele engagierte Seelen, die ihren Beruf mit brennendem Herzen angetreten hatten, nur um von starren Konzepten, festgefahrenen Methoden und seelenlosen Strukturen zerrieben und ausgebrannt zu werden. Das musste sich ändern. Das WÜRDE sich ändern.

So begann Lois, Gleichgesinnte um sich zu versammeln – Menschen, die nicht nur an ihre Vision glaubten, sondern sie mit Leidenschaft mittragen wollten. Fachärzte mit Herz. Erfahrene Haushaltshilfen mit Hingabe. Pflegekräfte, die ihre Berufung leben. Auf diesem Weg begegnete sie zwei weisen, älteren Menschen, die ihre Träume nicht belächelten, sondern sie ermutigten, den Lebenstraum ihrer verstorbenen Mutter – und ihren eigenen – endlich Wirklichkeit werden zu lassen.

Und so begann die Reise mit einem Symbol: dem Firmenlogo. Acht rote Punkte – jeder steht für eine Abteilung, jeder für einen Bereich, in dem Menschen anderen Menschen dienen. Doch diese Punkte stehen nicht isoliert: Sie sind vernetzt, verbunden, ein lebendiges Netzwerk aus Zusammenarbeit und gegenseitigem Respekt. Acht Abteilungen, geführt von acht Direktoren – wahre Experten ihres Fachs, die nicht nur Fachwissen mitbringen, sondern vor allem eines: Empathie. Jeder von ihnen lebt seine Berufung, jeder trägt Verantwortung für seinen Bereich und zugleich für das große Ganze – die Mission von OCTA.

Was OCTA heute ausmacht, ist das harmonische Zusammenspiel von privaten Dienstleistern, die Schaffung neuer Berufszweige und innovativer Berufsbezeichnungen, die Implementierung neuester Technologien und ein Arbeitsmodell, das seinesgleichen sucht. OCTA ist mehr als ein Unternehmen – es ist ein Ort, an dem Menschlichkeit, Professionalität und Innovation Hand in Hand gehen. Ein Ort, getragen vom Vermächtnis einer Familie, die verstanden hat, dass der größte Dienst am Menschen darin besteht, nicht nur zu pflegen, sondern zu inspirieren, nicht nur zu helfen, sondern Würde zu schenken.

Dies ist OCTA. Dies ist unsere Geschichte. Dies ist unser Versprechen.`,
    ...
    certifications: [
      ...
      { title: 'Betreuungskräfte nach § 43b SGB XI', desc: 'Qualifizierte Betreuungskräfte für zusätzliche Betreuungs- und Aktivierungsleistungen in der Pflege' },
      { title: 'Hauswirtschaftskräfte nach § 53c SGB XI', desc: 'Qualifiziertes Personal für hauswirtschaftliche Versorgungsleistungen' },
      { title: 'Pflegeberatung nach § 37 Abs. 3 SGB XI', desc: 'Zertifizierte Pflegeberater/innen für Beratungsbesuche bei häuslicher Pflege' },
      { title: 'Häusliche Krankenpflege nach § 132a SGB V', desc: 'Zugelassene Leistungserbringer für ambulante Pflegeleistungen' }
    ],
  ...
  en: {
    ...
    home: {
      ...
      intro1: 'As a certified provider of comprehensive care and support services, we stand by people in need of care and people with severe disabilities in all life situations – whether the required support is minor or complex in nature. Our service center combines professional care, household assistance, and individual support services under one roof to enable independent and dignified living in your own home or in assisted living arrangements.',
      intro2: 'All OCTA services ultimately serve a common goal: to be a reliable partner for people in need of care or with severe disabilities – from the smallest daily assistance to comprehensive nursing care. With our interdisciplinary team of certified nursing professionals, qualified care assistants, and qualified household staff, we offer you customized solutions that flexibly adapt to your individual needs and life situation.',
      intro3: 'Our goal is to create and maintain quality of life through professional competence, warmth, and reliability – regardless of whether you need light household support, intensive nursing care, or a combination of different services.',
      servicesTitle: 'Overview of Our Service Areas:',
      certTitle: 'Our Qualifications and Certifications',
      certIntro: 'All our services are provided by qualified and certified personnel who meet the legal requirements of German care legislation:',
      ctaText: 'Select one of our service areas from the navigation to get detailed information, or contact us for personal consultation.'
    },
    categories: {
      z1: {
      ...
      z2b: {
        title: 'CarePlus',
        desc: 'Feeling beautiful, being pampered, and participating in life – even when going out in public is difficult. With CarePlus, hairdresser, cosmetics, and wellness come discreetly to your home.',
        fullText: 'Many seniors know this feeling: You would love to treat yourself to a new haircut, pamper yourself with a soothing foot care treatment, or do something good for yourself with a beautiful manicure. Perhaps you even dream of a complete makeover with professional cosmetics. But the insecurity of going out in public alone, the fear of falling, or the shame about your own limitations holds you back. The desire to participate and to feel attractive and well-groomed remains unfulfilled.\n\nThis is exactly where our CarePlus concept comes in: We bring the services to your home! In your familiar, safe environment, you can be pampered without having to worry. Our cooperation partners are not only professionally qualified but also particularly empathetic in dealing with seniors. They take their time, respond to your wishes, and create a pleasant atmosphere – whether during a relaxed hairdresser visit at the kitchen table, during a soothing foot care treatment in the living room, or during an exciting makeover with professional cosmetic advice.\n\nYou don\'t have to worry about anything: We coordinate all appointments, establish contact with service providers, and ensure that everything goes according to your wishes. The professionals come directly to you with all necessary equipment and work discreetly, respectfully, and with great understanding for your situation. This way, despite limited mobility, you can continue to participate in life, feel beautiful, and treat yourself – without the stress of having to leave the house.',
        services: [
      ...
      z8: {
        ...
        fullText: 'Our Wellness Station was established with a memorial plaque dedicated to Andreas and Anna Iris Schmidt née Waldecker from Gilmerdingen. It embodies the lifelong dream of former nurse Anna Iris Schmidt – a loving mother of 11 children and late wife of Andreas Schmidt, as well as mother of OCTA owner Lois. Here prevails a very special atmosphere of well-being, permeated by this touching legacy.\n\nCare does not only mean medical care and support with daily activities – it also includes promoting joy in life, well-being, and quality of life. Our Wellness Station is a special place where you can find peace, gather new energy, and pursue activities that bring you joy. In a pleasant atmosphere, we offer you a diverse program that addresses body, mind, and soul equally.\n\nWhether you want to relax with gentle wellness applications, express your creativity through creative activities, or make new contacts in social gatherings – you will find the space for it here. We have developed special offerings particularly for people with dementia or cognitive impairments, based on scientifically founded concepts. Through targeted sensory stimulation, biography-oriented activities, and validating interaction, we create moments of joy and recognition. Relatives also appreciate our Wellness Station: they know their loved ones are well cared for and can take a breath themselves while they spend enriching time in a beautiful place.',
        services: [
          'Special atmosphere of well-being',
...
It was only a matter of time before Lois would unfold her extraordinary potential – not for herself, but for the next generation. She recognized that outpatient nursing care urgently needed a revolution: a revolution of humanity, innovation, and appreciation. Whether in direct patient care or household assistance – Lois saw the same pattern everywhere: outdated systems that had forgotten not only patients, but also the everyday heroes – the caregivers.

Because Lois fights not only for the dignity and wellbeing of patients and clients. The fate of employees is equally close to her heart – the people who day after day care, support, and help with their whole soul. She saw too many dedicated souls who had entered their profession with burning hearts, only to be ground down and burned out by rigid concepts, entrenched methods, and soulless structures. This had to change. This WOULD change.

So Lois began to gather like-minded people around her – individuals who not only believed in her vision, but wanted to carry it forward with passion. Physicians with heart. Experienced household helpers with dedication. Caregivers who live their calling. On this journey, she met two wise, elderly people who did not ridicule her dreams, but encouraged her to finally make the life dream of her deceased mother – and her own – a reality.

And so the journey began with a symbol: the company logo. Eight red dots – each represents a department, each a domain where people serve other people. But these dots do not stand in isolation: They are networked, connected, a living network of collaboration and mutual respect. Eight departments, led by eight directors – true experts in their fields, who bring not only professional knowledge, but above all one thing: empathy. Each of them lives their calling, each carries responsibility for their area and at the same time for the greater whole – the mission of OCTA.

What defines OCTA today is the harmonious interplay of private service providers, the creation of new professional fields and innovative job titles, the implementation of cutting-edge technologies, and a work model that is second to none. OCTA is more than a company – it is a place where humanity, professionalism, and innovation go hand in hand. A place carried by the legacy of a family that understood that the greatest service to humanity lies not only in caring, but in inspiring; not only in helping, but in granting dignity.

This is OCTA. This is our story. This is our promise.`,
        storyPlaceholder: false
      }
    },
    overviewItems: {
      ...
      z2b: { title: 'Z2b: CarePlus', desc: 'Wellness and participation at home – when going out in public is difficult' },
    ...
    certifications: [
      ...
      { title: 'Care Assistants according to § 43b SGB XI', desc: 'Qualified care assistants for additional support and activation services in care' },
      { title: 'Household Staff according to § 53c SGB XI', desc: 'Qualified personnel for household supply services' },
      { title: 'Care Consultation according to § 37 Para. 3 SGB XI', desc: 'Certified care consultants for consultation visits in home care' },
      { title: 'Home Nursing Care according to § 132a SGB V', desc: 'Approved service providers for outpatient nursing services' }
    ],
